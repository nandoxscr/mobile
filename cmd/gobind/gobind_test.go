...
var tests = []struct {
...
}{
	{
		name: "ObjC-Testpkg",
		lang: "objc",
		pkg:  "github.com/nandoxscr/mobile/bind/testdata/testpkg",
	},
	{
		name: "Java-Testpkg",
		lang: "java",
	...
	},
	{
		name:    "Java-Javapkg",
		lang:    "java",
		pkg:     "github.com/nandoxscr/mobile/bind/testdata/testpkg/javapkg",
		goos:    "android",
		reverse: true,
	},
	{
	...
	},
	{
		name: "Go-Cgopkg",
		lang: "go,java,objc",
		pkg:  "github.com/nandoxscr/mobile/bind/testdata/cgopkg",
		goos: "android",
	},
}
...
func testGobind(t *testing.T, exporter packagestest.Exporter) {
	...
	exported := packagestest.Export(t, exporter, []packagestest.Module{{
		Name:  "github.com/nandoxscr/mobile",
...
type Struct struct{
	...
	exported := packagestest.Export(t, exporter, []packagestest.Module{
		...
		{
			// gobind requires github.com/nandoxscr/mobile to generate code for reverse bindings.
			Name:  "github.com/nandoxscr/mobile",
			Files: packagestest.MustCopyFileTree("../.."),
		},
	})
