...
Requirements
  ...
  - Android SDK
  - Android NDK
  - `github.com/nandoxscr/mobile/cmd/gomobile`
...
`robpike.io/ivy` and `github.com/nandoxscr/mobile` are required dependencies of this main module. In order to update them:

```
  go get -d github.com/nandoxscr/mobile@latest
