...
import (
	...
	"github.com/nandoxscr/mobile/internal/importers/java"
...
func TestClasses(t *testing.T) {
	...
	runTest(t, []string{
		"github.com/nandoxscr/mobile/bind/testdata/testpkg/javapkg",
	}, "", "ClassesTest")
}
...
func TestJavaSeqBench(t *testing.T) {
	...
	runTest(t, []string{"github.com/nandoxscr/mobile/bind/testdata/benchmark"}, "", "SeqBench")
}
